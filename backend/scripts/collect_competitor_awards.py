...
# 주의: "다인"은 자주 쓰이는 단어라 수동 검수 필요 (다인피아이디, 다인씨엠건축사사무소 등 제외 필요)
...
def fetch_awards_for_range(start_date: datetime, end_date: datetime) -> List[Dict[str, Any]]:
    """
...
def collect_competitor_awards() -> None:
    """
    ...
    while current_start <= end_date:
        ...
        # 1주일 데이터 수집
        all_items = fetch_awards_for_range(current_start, current_end)
